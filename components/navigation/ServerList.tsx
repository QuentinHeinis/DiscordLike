...
const ServerList = ({servers} : {servers:Server[]}) => {  
  ...
  return (
    <>
      ...
      <button onClick={()=>setModalOpen('addServer')} className='bg-neutral-500 h-14 w-14 rounded-full grid place-content-center mt-3'><PlusIcon className='h-8 w-8'/></button>
    </>
  )
}
