...
const ServerBubble = ({link, isHome, img, name}:BubbleType) => {
  ...
  return(
    <div className={`after:h-14 after:dark:bg-white after:bg-neutral-500 after:rounded-tr-xl after:rounded-br-xl after:w-1 after:-translate-y-full after:relative after:-left-3  ${getId === linkId ? 'after:flex -mb-14' : 'after:hidden'}`}>
