...
const ServerHeader = ({serverName, inviteCode, server}:ServerHeaderType) => {
  ...
  return (
      <div className='group relative w-full bg-slate-500 flex justify-around items-center h-16 border-b border-slate-200'>
        ...
        <div className='h-0 group-hover:h-fit group-hover:visible pt-2 pb-2 transition-all scale-50 invisible flex gap-1 flex-col items-center group-hover:scale-100 overflow-hidden absolute w-[95%] bg-slate-500 top-full'>
